...
// import User from 'C:/Users/MSI/Desktop/conference/api/models/user.model.js';
        ...
        <>
          <Table hoverable className='shadow-md'>
            <Table.Head>
              ...
              <Table.HeadCell>Registered Events</Table.HeadCell>
            ...
            {users.map((user) => (
              <Table.Body className='divide-y' key={user._id}>
                <Table.Row className='bg-white dark:border-gray-700 dark:bg-gray-800'>
                  ...
                  <Table.Cell>{user.registeredPostsCount}</Table.Cell>
                  <Table.Cell>
                    <span
                      onClick={() => {
                        setShowModal(true);
